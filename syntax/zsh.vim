...
syn keyword zshBuiltin alias autoload bg bindkey break bye cap cd chdir clone comparguments compcall
      ...
      \ continue dirs disable disown echo echotc echoti emulate enable eval exec exit false fc fg
      \ functions getcap getln getopts hash history jobs kill let limit log logout popd print printf
      \ pushd pushln pwd r read rehash return sched set setcap shift source stat suspend test times
      \ trap true ttyctl type ulimit umask unalias unfunction unhash unlimit unset vared wait whence
